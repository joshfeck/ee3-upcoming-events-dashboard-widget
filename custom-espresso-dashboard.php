<?php
/*
Plugin Name: Custom Event Espresso Dashboard Widget
Plugin URI: http://github.com/
Description: A plugin that customizes Event Espresso's dashboard widget
Version: 1.0
Author: Event Espresso, Josh Feck
License: GPLv2
*/

// WP Event Dashboard Widget Table Function
function custom_event_espresso_edit_list_widget(){
...
add_action('wp_dashboard_setup', 'custom_event_espresso_dashboard_widget');

function custom_event_espresso_dashboard_widget() {
    ...
    remove_meta_box( 'todays_events_widget', 'dashboard', 'normal' );
    wp_add_dashboard_widget('upcoming_events_widget', __('Upcoming Events', 'event_espresso'), 'custom_custom_dashboard_events');
}

function custom_custom_dashboard_events() {
    custom_event_espresso_edit_list_widget();
    global $how_many_events;
